...
## Getting Started
If you are new to robotics or new to the *FIRST* Tech Challenge, then you should consider reviewing the [FTC Blocks Tutorial](https://github.com/team6749/FTC-18167-2023/releases) to get familiar with how to use the control system:

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[FTC Blocks Online Tutorial](https://github.com/team6749/FTC-18167-2023/releases)

Even if you are an advanced Java programmer, it is helpful to start with the [FTC Blocks tutorial](https://github.com/team6749/FTC-18167-2023/releases), and then migrate to the [OnBot Java Tool](https://github.com/team6749/FTC-18167-2023/releases) or to [Android Studio](https://github.com/team6749/FTC-18167-2023/releases) afterwards.
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;git clone https://github.com/team6749/FTC-18167-2023/releases</p>

* Or, if you prefer, you can use the "Download Zip" button available through the main repository page.  Downloading the project as a .ZIP file will keep the size of the download manageable.

* You can also download the project folder (as a .zip or https://github.com/team6749/FTC-18167-2023/releases archive file) from the Downloads subsection of the [Releases](https://github.com/team6749/FTC-18167-2023/releases) page for this repository.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[FIRST Tech Challenge Documentation](https://github.com/team6749/FTC-18167-2023/releases)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[FTC Javadoc Documentation](https://github.com/team6749/FTC-18167-2023/releases)

### Online User Forum
For technical questions regarding the Control System or the FTC SDK, please visit the FIRST Tech Challenge Community site:

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[FIRST Tech Challenge Community](https://github.com/team6749/FTC-18167-2023/releases)
...
The https://github.com/team6749/FTC-18167-2023/releases file located in the [/TeamCode/src/main/java/org/firstinspires/ftc/teamcode](TeamCode/src/main/java/org/firstinspires/ftc/teamcode) folder contains an explanation of the sample naming convention, and instructions on how to copy them to your own project space.
...
* Updated CENTERSTAGE library AprilTag orientation quaternions
    * Thanks [@FromenActual](https://github.com/team6749/FTC-18167-2023/releases)
* Updated Java Sample https://github.com/team6749/FTC-18167-2023/releases to include missing elements needed for custom model support.
...
* Blocks teams can now perform webcam calibration.
    * Added a Block for https://github.com/team6749/FTC-18167-2023/releases (under Utilities/Time)
    * Added a Block for https://github.com/team6749/FTC-18167-2023/releases (under Vision/VisionPortal)
...
* Fixes a bug where passing an integer number such as 123 to the https://github.com/team6749/FTC-18167-2023/releases block that takes a number shows up as 123.0 in the telemetry.
...
* https://github.com/team6749/FTC-18167-2023/releases has been moved.  It is still in the git history, but has been removed from the git snapshot corresponding with the 8.2 tag.  The official version now lives at [Field Coordinate System](https://github.com/team6749/FTC-18167-2023/releases).
* `https://github.com/team6749/FTC-18167-2023/releases()` and `https://github.com/team6749/FTC-18167-2023/releases()` have been replaced with `https://github.com/team6749/FTC-18167-2023/releases()`.
...
* Related documentation for associated technologies can be found at
    * [AprilTag Introduction](https://github.com/team6749/FTC-18167-2023/releases)
    * [AprilTag SDK Guide](https://github.com/team6749/FTC-18167-2023/releases)
    * [AprilTag Detection Values](https://github.com/team6749/FTC-18167-2023/releases)
    * [AprilTag Test Images](https://github.com/team6749/FTC-18167-2023/releases)
    * [Camera Calibration](https://github.com/team6749/FTC-18167-2023/releases)
...
### Bug Fixes
* Corrects inspection screen to report app version using the SDK version defined in the libraries instead of the version specified in `https://github.com/team6749/FTC-18167-2023/releases`. This corrects the case where the app could show matching versions numbers to the user but still state that the versions did not match.
  * If the version specified in `https://github.com/team6749/FTC-18167-2023/releases` does not match the SDK version, an SDK version entry will be displayed on the Manage webpage.
* Fixes no error being displayed when saving a configuration file with duplicate names from the Driver Station.
* Fixes a deadlock in the UVC driver which manifested in https://github.com/team6749/FTC-18167-2023/releases
...
* [Issue #492](https://github.com/team6749/FTC-18167-2023/releases) - Can't create new blocks opmodes.
* [Issue #495](https://github.com/team6749/FTC-18167-2023/releases) - Remove the final modifier from the OpMode's Telemetry object.
* [Issue #500](https://github.com/team6749/FTC-18167-2023/releases) - Some devices cannot be configured when the Driver Station app has been updated to 8.1
...
* Deprecates (and stops respecting) `https://github.com/team6749/FTC-18167-2023/releases`.
...
* Adds a new `IMU` interface to Blocks and Java that can be used with both the original BNO055 IMU
  ...
  * To learn how to use the new `IMU` interface, see https://github.com/team6749/FTC-18167-2023/releases The `SensorIMU` Blocks sample was also updated to use the new `IMU` interface, and the following Java samples were added:
    * `SensorIMUOrthogonal`
  ...
  * If you have calibrated your BNO055, you can provide that calibration data to the new `IMU`
    interface by passing a `https://github.com/team6749/FTC-18167-2023/releases` instance to `https://github.com/team6749/FTC-18167-2023/releases()`.
...
* Allows customized versions of device drivers in the FTC SDK to use the same XML tag.
  ...
  * Now, to use your custom driver, all you have to do is specify your custom driver's class when
    calling `https://github.com/team6749/FTC-18167-2023/releases()`. To go back to the original driver, specify the original driver
...
* Fixes [issue #251](https://github.com/team6749/FTC-18167-2023/releases) by changing the order in which axis rotation rates are read from the angular velocity vector in the BNO055 IMU driver.
* Deprecates `pitchMode` in `https://github.com/team6749/FTC-18167-2023/releases`.
  * Setting `pitchMode` to `https://github.com/team6749/FTC-18167-2023/releases` would break the coordinate conventions used by the driver.
* Moves `OpModeManagerImpl` to the `https://github.com/team6749/FTC-18167-2023/releases` package.
...
* Deletes the protected `https://github.com/team6749/FTC-18167-2023/releases` class (which was not meant for use by OpModes).
...
* Adds new Java sample to demonstrate using a hardware class to abstract robot actuators, and share them across multiple OpModes.
  * Sample OpMode is [https://github.com/team6749/FTC-18167-2023/releases](https://github.com/team6749/FTC-18167-2023/releases)
  * Abstracted hardware class is [https://github.com/team6749/FTC-18167-2023/releases](https://github.com/team6749/FTC-18167-2023/releases)
...
* Adds opt-in support for Java 8 language features to the OnBotJava editor.
  ...
  * Please report issues [here](https://github.com/team6749/FTC-18167-2023/releases).
...
### Bug fixes
* Fixes [issue #316](https://github.com/team6749/FTC-18167-2023/releases) (https://github.com/team6749/FTC-18167-2023/releases() returned an incorrectly-sized matrix for 1x1 and 2x2 matrixes).
...
* Removes https://github.com/team6749/FTC-18167-2023/releases sample program.  This sample is not compatible with OnBotJava.
...
* Fixes [Blocks Programs Stripped of Blocks (due to using TensorFlow Label block)](https://github.com/team6749/FTC-18167-2023/releases)

## Version 7.1 (20211223-120805)

* Fixes crash when calling `isPwmEnabled()` ([issue #223](https://github.com/team6749/FTC-18167-2023/releases)).
* Fixes lint error ([issue #4](https://github.com/team6749/FTC-18167-2023/releases)).
* Fixes Driver Station crash when attempting to use DualShock4 v1 gamepad with Advanced Gamepad Features enabled ([issue #173](https://github.com/team6749/FTC-18167-2023/releases)).
...
* Fixes [issue #259](https://github.com/team6749/FTC-18167-2023/releases) Most blocks samples for TensorFlow can't be used for a different model.
...
* Fixes [issue #260](https://github.com/team6749/FTC-18167-2023/releases) Blocks can't call java method that has a VuforiaLocalizer parameter.
    * Blocks now has a block labeled https://github.com/team6749/FTC-18167-2023/releases for this.
...
* Adds support for external libraries to OnBotJava and Blocks.
    ...
    * External libraries can provide support for hardware devices by using the annotation in the
      https://github.com/team6749/FTC-18167-2023/releases package.
    ...
    * External libraries that use the following annotations can be used from Blocks OpModes.
      * https://github.com/team6749/FTC-18167-2023/releases
      * https://github.com/team6749/FTC-18167-2023/releases
...
* Adds support for I2C transactions on the Expansion Hub / Control Hub without specifying a register address.
    * See section 3 of the [TI I2C spec](https://github.com/team6749/FTC-18167-2023/releases).
 ...
 * Fixes [FtcRobotController issue #114](https://github.com/team6749/FTC-18167-2023/releases)
...
### Bug fixes
* Fixes [FtcRobotController issue #71](https://github.com/team6749/FTC-18167-2023/releases)
  Cannot open OpModes in v6.1 Blocks offline editor
* Fixes [FtcRobotController issue #79](https://github.com/team6749/FTC-18167-2023/releases)
...
* Fixes certain I2C devices not showing up in the appropriate `HardwareMap` fields (such as `https://github.com/team6749/FTC-18167-2023/releases`)
...
* Fixes [ftc_app issue 673](https://github.com/team6749/FTC-18167-2023/releases) Latest matchlog is being deleted instead of old ones by RobotLog
...
* Makes the scan button on the configuration screen update the list of Expansion Hubs connected via RS-485
    * Fixes [SkyStone issue #143](https://github.com/team6749/FTC-18167-2023/releases)
...
* Introduces an automatic TeleOp preselection feature
    * For details and usage guide, please see [this wiki entry](https://github.com/team6749/FTC-18167-2023/releases)
...
### New features
* Adds support for calling custom Java classes from Blocks OpModes (fixes [SkyStone issue #161](https://github.com/team6749/FTC-18167-2023/releases)).
    * Classes must be in the https://github.com/team6749/FTC-18167-2023/releases package.
    * To have easy access to the opMode, hardwareMap, telemetry, gamepad1, and gamepad2, classes can
      extends https://github.com/team6749/FTC-18167-2023/releases
    * Methods must be public static and have no more than 21 parameters.
    * Methods must be annotated with https://github.com/team6749/FTC-18167-2023/releases
    ...
    * Parameters declared as char or https://github.com/team6749/FTC-18167-2023/releases will accept any block that returns text
      and will only use the first character in the text.
    * Parameters declared as boolean or https://github.com/team6749/FTC-18167-2023/releases will accept any block that returns boolean.
    * Parameters declared as byte, https://github.com/team6749/FTC-18167-2023/releases, short, https://github.com/team6749/FTC-18167-2023/releases, int, https://github.com/team6749/FTC-18167-2023/releases,
      long, or https://github.com/team6749/FTC-18167-2023/releases,  will accept any block that returns a number and will round that
      value to the nearest whole number.
    * Parameters declared as float, https://github.com/team6749/FTC-18167-2023/releases, double, https://github.com/team6749/FTC-18167-2023/releases will accept any
...
* Update/refresh build infrastructure
    * Update to 'androidx' support library from 'https://github.com/team6749/FTC-18167-2023/releases', which is end-of-life
...
### Bug fixes
* Fixes [SkyStone issue #248](https://github.com/team6749/FTC-18167-2023/releases)
* Fixes [SkyStone issue #232](https://github.com/team6749/FTC-18167-2023/releases) and
...
* Improves generation of fake serial numbers for UVC cameras which do not provide a real serial number
	...
	* Fixes [ftc_app issue #638](https://github.com/team6749/FTC-18167-2023/releases).
...
* Fixes issue in UVC driver on some devices ([ftc_app 681](https://github.com/team6749/FTC-18167-2023/releases)) if streaming was started/stopped multiple times in a row
    * Issue manifested as kernel panic on devices which do not have [this kernel patch](https://github.com/team6749/FTC-18167-2023/releases).
...
* Fixes a potential exploitation issue of [CVE-2019-11358](https://github.com/team6749/FTC-18167-2023/releases) in OnBotJava
...
* Fix RenderScript usage
    * Use https://github.com/team6749/FTC-18167-2023/releases variant: increased compatibility
...
* Fixes [SkyStone issue #88](https://github.com/team6749/FTC-18167-2023/releases)
* Adds an inspection item that notes when a robot controller (Control Hub) is using the factory default password.
* Fixes [SkyStone issue #61](https://github.com/team6749/FTC-18167-2023/releases)
* Fixes [SkyStone issue #142](https://github.com/team6749/FTC-18167-2023/releases)
* Fixes [ftc_app issue #417](https://github.com/team6749/FTC-18167-2023/releases) by adding more current and voltage monitoring capabilities for REV Hubs.
* Fixes [a crash sometimes caused by OnBotJava activity](https://github.com/team6749/FTC-18167-2023/releases)
* Improves OnBotJava autosave functionality [ftc_app #738](https://github.com/team6749/FTC-18167-2023/releases)
...
* Fixes issue where https://github.com/team6749/FTC-18167-2023/releases() would fail if it was called too early
* Adds https://github.com/team6749/FTC-18167-2023/releases() methods and blocks, which cause the Driver Station (if also updated) to speak text
...
* Adds bulk read functionality for REV Hubs
  ...
  * The following following Hub bulk caching modes are available:
    * `https://github.com/team6749/FTC-18167-2023/releases` (default): All hardware calls operate as usual. Bulk data can read through `LynxModule#getBulkData()` and processed manually.
    * `https://github.com/team6749/FTC-18167-2023/releases`: Applicable hardware calls are served from a bulk read cache that is cleared/refreshed automatically to ensure identical commands don't hit the same cache. The cache can also be cleared manually with `LynxModule#clearBulkCache()`, although this is not recommended.
    * (advanced users) `https://github.com/team6749/FTC-18167-2023/releases`: Same as `https://github.com/team6749/FTC-18167-2023/releases` except the cache is never cleared automatically. To avoid getting stale data, the cache must be manually cleared at the beginning of each loop body or as the user deems appropriate.
...
* Fixes [ftc_app issue #712](https://github.com/team6749/FTC-18167-2023/releases) (thanks to FROGbots-4634)
* Fixes [ftc_app issue #542](https://github.com/team6749/FTC-18167-2023/releases)
...
* Includes 64-bit support (to comply with [Google Play requirements](https://github.com/team6749/FTC-18167-2023/releases)).
* Protects against Stuck OpModes when a Restart Robot is requested. (Thanks to FROGbots-4634) ([ftc_app issue #709](https://github.com/team6749/FTC-18167-2023/releases))
* Blocks related changes:
   ...
   * Displays warning icon when outdated Vuforia and TensorFlow blocks are used ([SkyStone issue #27](https://github.com/team6749/FTC-18167-2023/releases))
...
* Fixes [SkyStone issue #9](https://github.com/team6749/FTC-18167-2023/releases)
* Fixes [ftc_app issue #715](https://github.com/team6749/FTC-18167-2023/releases)
...
Known issues:
* Camera Stream
    * The Vuforia camera stream inherits the issues present in the phone preview (namely [ftc_app issue #574](https://github.com/team6749/FTC-18167-2023/releases)). This problem does not affect the TFOD camera stream even though it receives frames from Vuforia.
 ...
 * Includes fix to avoid deadlock situation with WatchdogMonitor which could result in USB communication errors.
     ...
     - https://github.com/team6749/FTC-18167-2023/releases would have error messages that included the words "E RobotCore: lynx xmit lock: #### abandoning lock:"
 ...
 * Added google() repo to https://github.com/team6749/FTC-18167-2023/releases because aapt2 must be downloaded from the google() repository beginning with version 3.2 of the Android Gradle Plugin.
     ...
     - This should also fix buid issue where Android Studio would complain that it "Could not find https://github.com/team6749/FTC-18167-2023/releases" (or similar).
 ...
 * Improvements to https://github.com/team6749/FTC-18167-2023/releases block with "text" socket.
 ...
 * Initial support for UVC compatible cameras
    ...
    - Calibration settings for a few cameras are included (see https://github.com/team6749/FTC-18167-2023/releases for details).
 ...
 * Removed unneeded resources from https://github.com/team6749/FTC-18167-2023/releases binaries used by OnBot Java to reduce final size of Robot Controller app.
 ...
 * Added https://github.com/team6749/FTC-18167-2023/releases() statement for BlankLinearOpMode template.
 ...
 * Robot Controller log has been renamed to https://github.com/team6749/FTC-18167-2023/releases (note that this change was actually introduced w/ v3.2).
 ...
 * Blocks
    ...
    - Added blocks for https://github.com/team6749/FTC-18167-2023/releases and https://github.com/team6749/FTC-18167-2023/releases
...
* Blocks Programming Development Tool:
    ...
    - Fixed tooltip for https://github.com/team6749/FTC-18167-2023/releases block.
    Added blocks for https://github.com/team6749/FTC-18167-2023/releases and https://github.com/team6749/FTC-18167-2023/releases
...
Changes include:
 * Blocks changes
    - Added https://github.com/team6749/FTC-18167-2023/releases and https://github.com/team6749/FTC-18167-2023/releases blocks.
    - Added optimized blocks support for Vuforia extended tracking.
    - Added atan2 block to the math category.
    - Added useCompetitionFieldTargetLocations parameter to https://github.com/team6749/FTC-18167-2023/releases block.  If set to false, the target locations are placed at (0,0,0) with target orientation as specified in https://github.com/team6749/FTC-18167-2023/releases tutorial OpMode.
...
## Version 2.5 (internal release on released on 16.12.13)
  * Blocks Programming mode changes:
     ...
     - Added Download OpMode button to https://github.com/team6749/FTC-18167-2023/releases
     ...
     - Added type safety to blocks for https://github.com/team6749/FTC-18167-2023/releases
     ...
     - Added type safety to blocks for enums in https://github.com/team6749/FTC-18167-2023/releases
...
## Version 2.4 (released on 16.11.13)
  ...
  * Blocks Programming mode changes:
     ...
     - Added blocks to support https://github.com/team6749/FTC-18167-2023/releases
  ...
  * Limit unbounded growth of data for telemetry.  If user does not call https://github.com/team6749/FTC-18167-2023/releases() for LinearOpMode in a timely manner, data added for telemetry might get lost if size limit is exceeded.
 ...
 * Blockly enhancements
    - support for https://github.com/team6749/FTC-18167-2023/releases
 ...
 * https://github.com/team6749/FTC-18167-2023/releases() method has been overloaded so it can support this operation for int, short and byte integers.
 ...
 * For LinearOpMode the user now must for a https://github.com/team6749/FTC-18167-2023/releases() to update the telemetry data on the driver station.  This update() mechanism ensures that the driver station gets the updated data properly and at the same time.
 ...
 * Changes made to make the FTC SDK synchronous (significant change!)
    ...
    - For example, if you call setMode(https://github.com/team6749/FTC-18167-2023/releases) for a motor, the encoder is guaranteed to be reset when the method call is complete.
 ...
 * Fixed formatting error in https://github.com/team6749/FTC-18167-2023/releases().
 ...
 * https://github.com/team6749/FTC-18167-2023/releases and .getConnectionInfo() return null
 ...
 * Added Support for Modern Robotics Gyro.
  ...
  - Example https://github.com/team6749/FTC-18167-2023/releases OpMode included.
 ...
 * Updated/cleaned up OpModes.
  - Updated comments in https://github.com/team6749/FTC-18167-2023/releases example OpMode.
  - Replaced the calls to "setChannelMode" with "setMode" (to match the new of the DcMotor  method).
  - Removed https://github.com/team6749/FTC-18167-2023/releases OpMode.
  - Added https://github.com/team6749/FTC-18167-2023/releases OpMode (demonstrates how to use MR Gyro Sensor).
  - Added https://github.com/team6749/FTC-18167-2023/releases OpMode (demonstrates how to use MR Color Sensor).
  - Added https://github.com/team6749/FTC-18167-2023/releases OpMode (demonstrates how to use HT legacy color sensor).
  - Added https://github.com/team6749/FTC-18167-2023/releases (demonstrates how to use legacy Matrix controller).
 ...
 * Cleaned up https://github.com/team6749/FTC-18167-2023/releases file.
 ...
 * A new LinearOpMode class is introduced.
   ...
   - Teams can use blocking statements like https://github.com/team6749/FTC-18167-2023/releases() within a linear OpMode.
